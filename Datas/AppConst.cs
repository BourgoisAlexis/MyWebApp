namespace BlazorApp1.Datas {
    public static class AppConst {
        public static string light = "#f8f9fa";
        public static string lightColor = "#ffc4cb";

        public static string dark = "#212529";

        public static string color = "#ff4654";
